  ...
  <div class="form-group" style="margin-top: 30px">
   <h1 style="text-align: center; font-family: cursive; padding-bottom: 20px;font-weight: bold;color: black">EDIT ANNOUNCEMENT</h1>
  </div>
  <div class="row">
    <div class="col-md-7">
        ...
        <input type="text" id="InputEmail1" style=" width:80%; padding-left:250px;border-radius: 3px; border:2px solid black; margin-left: 20px;"> <br/>
        <label for="course" style="font-size: 17px; text-align: center; font-family: cursive; ">Course:</label>
         <input type="text" id="InputPassword1" style=" width:33%; border-radius: 3px;border:2px solid black; margin-left: 5px">
          <label for="periode" style="font-size: 17px; text-align: center; font-family: cursive; ">Periode:</label>
         <input type="text" id="InputPassword1" style="width:35%; border-radius: 3px;border:2px solid black">
      </div>
    </div>
    <div class="col-md-5">
    ...
    <div style="padding-right:55px; float:right; margin-top: 50px;">
  ...
  <button type="submit" class="btn btn-primary" style="align-content: center; margin-left: 750px; background-color: #cc0000;margin-bottom: 50px; margin-top: 30px;font-family: cursive;">Edit Announcement</button>
</form>
    </div>
