<form action="<?php echo site_url('Lecturer/create') ?>" method="POST">
  ...
  <div class="row">
    <div class="col-md-7">
      	...
      	<div  style="background-color: white; padding-bottom: 15px; border-radius: 5px;padding-left: 10px">
    		...
    		<input type="text" name="title" value="<?php  ?>"style=" width:80%; padding-left:250px;border-radius: 3px; border:2px solid black; margin-left: 20px;"> <br/>
    		<label for="course" style="font-size: 17px; text-align: center; font-family: cursive; ">Course:</label>
   			 <input type="text" name="course"value="<?php  ?>" style=" width:33%; border-radius: 3px;border:2px solid black; margin-left: 5px">
   			 	<label for="periode" style="font-size: 17px; text-align: center; font-family: cursive; ">Periode:</label>
   			 <input type="text" name="period" value="<?php  ?>" style="width:35%; border-radius: 3px;border:2px solid black">
    	</div>
    </div>
    <div class="col-md-5">
      	...
      	<div style="  margin-top :50px; float : left; margin-bottom: : 30px;">
  			...
  			<select name="faculty">
  			<option value="<?php echo ?>"><?php  ?></option>
  ...
  <input type="submit" class="btn btn-primary" value="Edit Announcement" style="align-content: center; margin-left: 750px; background-color: #cc0000;margin-bottom: 50px; margin-top: 30px;font-family: cursive; color:white">
</div>
</form>
</body>
</html>
