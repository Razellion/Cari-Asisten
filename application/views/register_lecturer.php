	<div>
			<div class="container-create"style="width: 500px;height: 400px;background-color:white;color:black;margin-left: 35%; margin-top: 50px; border-radius: 15px; border: 2px solid black;">
			...
			<div style="margin-top: 35px;height: 250px;width: 380px;margin-left: 15px;">
				...
				<div>
					<button type="submit" style=" border :none; background-color:#cc0000; width: 100px; height: 30px; margin-left: 350px; ">
						<p style=" padding-top:2px; font-size:15px; font-family:cursive; text-align:center; color: white;">Next</p>
					</button>
				</div>
			</div>
			</form>
