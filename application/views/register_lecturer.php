	<div>
		<form>
			<div class="container-create"style="width: 500px;height: 430px;background-color:white;color:black;margin-left: 650px; margin-top: 50px; border-radius: 15px; border: 2px solid black;">
			...
			<div style="margin-top: 35px;height: 250px;width: 380px;margin-left: 15px;">
				...
				<div class="row" style="margin-bottom: 20px;">
					...
					<div class="col-sm-8"><input style="width :300px; border: 2px solid black;"  type="text" id="fpassword" name="PASS"></div>
				</div>
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-sm-4">Phone No: </div>
					<div class="col-sm-8"><input style="width:300px; border: 2px solid black;"  type="text" id="fphone" name="Phone"></div>
				</div>
				<div class="row" style="margin-bottom: 20px;">
				...
				<div>
					<button style=" border :none; background-color:#cc0000; width: 100px; height: 30px; margin-left: 350px; ">
